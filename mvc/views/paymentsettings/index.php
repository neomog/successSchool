                                    ...
                                    <div class="col-sm-12">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group <?= form_error('stripe_key') ?'has-error':'' ?>" >
                                                <label for="stripe_key" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("stripe_key")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" id="stripe_key" name="stripe_key" value="<?=set_value('stripe_key', $set_key['stripe_key'])?>" >
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('stripe_key'); ?>
                                                </span>
                                            </div>
